										...
										if($item['mark'] === "video") {
											...
											?>
												<div class="gallery-wrapper" style="position: relative;">	
													<a href="#" data-bs-toggle="modal" data-bs-target="#viewVideo<?php echo $item['uid']; ?>">
														<video 
													...
													<div class="modal fade" id="viewVideo<?php echo $item['uid'] ?>" tabindex="-1">
														<div class="modal-dialog modal-lg modal-dialog-centered">
															<div class="modal-content">
																<div class="modal-header register-header">
																<h5 class="modal-title registers-title"><?php echo $item['title'] ?></h5>
