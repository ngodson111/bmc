...
<div class="modal fade" id="settings" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-sm" role="document">
        ...
        <div class="modal-body p-0">
            <div class="password mt-3"><a rel="noopener" target="_blank" href="http://newhorizoncollege.edu.np/" style="text-decoration:none;color:black;">Visit Site</a></div>
            <div data-dismiss="modal" data-toggle="modal" data-target="#password" class="password mt-3">Password</div>
            <div data-dismiss="modal" data-toggle="modal" data-target="#backup" class="password mt-3">Backup & Restore</div>
...
<div class="modal fade" id="password" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-sm" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <p class="my-0">
                    <span style="cursor:pointer;" data-dismiss="modal" data-toggle="modal" data-target="#settings"><i class="fas fa-chevron-left mr-2"></i></span>
            ...
            <form method="post" class="modal-body mt-2 mb-3">
                ...
                <input name="confirmpassword" type="password" class="confirm w-100 mb-3" placeholder="Confirm Password" required>
                <div class="show mb-3">
                    <input type="checkbox">
                        ...
                        <?php
                            ...
                            if(count($myfiles)>1) {
                                for($i=1;$i<count($myfiles);$i++) {
                                    ?>
                                        <tr>
                                            <td style="font-size:15px;"><i style="font-weight:600;font-size:19px" class="fas fa-file-code mr-2"></i><?php echo $myfiles[$i] ?></td>
                                            <td style="display:flex;">
                                                <a rel="noopener" class="mr-1 btn btn-sm btn-info" download href="./backup/<?php echo $myfiles[$i]; ?>">
                                                    <i class="fas fa-download"></i>
                                                </a>
                                                <a rel="noopener" class="btn btn-sm btn-danger" href="./backup/php/deletebackup.php?ipxname=<?php echo $myfiles[$i]; ?>">
