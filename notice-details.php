...
<head>
        ...
        <title>Notice-details || Butwal Model College</title>
		...
		<div class="blog-details-area pt-130 pb-100">
			<div class="container">
				<div class="row flex-column-reverse flex-lg-row">
					<?php
						if(empty($_GET['id'])) {
							?><script>location.href = "notice.php"</script><?php
						}
					...
					<div class="col-lg-3">
						<div class="widget mb-30">
							<h5 class="widget-course-title">Latest Notice</h5>
													...
													<div class="widget-latest-blog">
														<div class="widget-latest-blog-img">
															...
															<div class="widget-latest-blog-content">
																<h5><a href="notice-details.php?id=<?php echo $item['uid']; ?>"><?php echo $item['title']; ?></a></h5>
									...
									if($_GET['id'] === $item['uid']){
										?>
											...
											<div class="blog-thumb">
												<a href="#"><img src="./admin/content/assets/img/notice/<?php echo $item['image']; ?>" alt=""></a>
											</div>
										<?php
									}
								}
