...
<head>
        ...
        <title>Council-details || Butwal Model College</title>
							...
							<div class="main-menu text-center">
								<nav>
									<ul>
										...
										<!-- <li class="active"><a href="council.php">Council</a></li> -->
		...
		<div class="blog-details-area pt-130 pb-100">
			<div class="container">
				<div class="row flex-column-reverse flex-lg-row">
					<?php
						if(empty($_GET['id'])) {
							?><script>location.href = "council.php"</script><?php
						}
						include("./admin/content/php/viewcouncil.php");
												...
												<li>
													<div class="widget-latest-blog">
														<div class="widget-latest-blog-img">
															<a href="council-details.php?id=<?php echo $item['uid']; ?>">
																<img 
																	src="./admin/content/assets/img/council/<?php echo $item['image']; ?>" 
																	alt="" 
																	style="height: 150px; object-fit: cover;"
																/>
															</a>
															<div class="widget-latest-blog-content">
																<h5><a href="council-details.php?id=<?php echo $item['uid']; ?>"><?php echo $item['title']; ?></a></h5>
									...
									if($_GET['id'] === $item['uid']){
										?>
											...
											<div class="blog-thumb">
												<a href="#"><img src="./admin/content/assets/img/council/<?php echo $item['image']; ?>" alt=""></a>
											</div>
										<?php
									}
								}
