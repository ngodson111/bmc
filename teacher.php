...
<head>
        ...
        <title>Faculty Members || Butwal Model College</title>
									...
									<div class="col-lg-4 col-md-6">
										<div class="courses-wrapper mb-80">
											...
											<div class="courses-content">
												...
												<a href="#"  data-bs-toggle="modal" data-bs-target="#viewteacher<?php echo $item['uid']; ?>">Read More</a>
											</div>
											<!-- Modal -->
											<div class="modal fade" id="viewteacher<?php echo $item['uid']; ?>" tabindex="-1">
												<div class="modal-dialog modal-lg modal-dialog-centered">
													<div class="modal-content">
														<div class="modal-header register-header">
														<h5 class="modal-title registers-title">Teacher Details</h5>
...
<!-- Mirrored from htmldemo.net/shiksha/shiksha/courses-grid.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 22 Aug 2022 09:44:05 GMT -->
</html>
