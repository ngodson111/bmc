...
<head>
        ...
        <title>Contact || Butwal Model College</title>
    ...
    <body>
		...
		<div class="page-title-area ptb-170 bg-opacity-6" style="background-image:url(assets/img/bg/17.jpg)">
			<div class="container">
				<div class="row">
					<div class="col-md-12">
			...
			<div class="container">
				<div class="map-wrapper pos-relative">
					<div id="map">
						<iframe 
							class="map-2" 
							src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3537.339376706856!2d83.4607861150587!3d27.551975982856487!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x39969ae25ded981f%3A0x1c605ef28b528d2!2sButwal%20Model%20College!5e0!3m2!1sen!2snp!4v1661499627172!5m2!1sen!2snp"></iframe>
					</div>
					<div class="map-content">
						<ul>
							<li><i class="ti-location-pin"></i>Butwal, Rupandehi, Nepal</li>
							<li><i class="ti-timer"></i>9.00 am - 5.00 pm</li>
							<li><i class="ti-mobile"></i>Phone : +977-9800000000 </li>
							<li><i class="ti-email"></i>Email : bmc@email.com,</li>
						</ul>
					</div>
				</div>
			</div>
		...
		<!-- map-2-area-end -->
		<!-- contact-area-start -->
		<div class="contact-area pb-130">
			<div class="container">
				<div class="row">
					<div class="col-12">
						<div class="contact-wrapper">
							<h4>Feel free to write us</h4>
							<form action="./admin/content/php/insertmessages.php" id="contact-formfield" method="POST">
								<div class="row">
									<div class="col-md-6">
									...
									<div class="col-12">
										<textarea name="remark" cols="30" rows="10" placeholder="Type your message here.." id="message" required></textarea>
									</div>
									<div class="col-12">
										<button type="submit" name="messagesbtn">submit</button>
									</div>							
								</div>
							</form>
