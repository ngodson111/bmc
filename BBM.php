...
<head>
        ...
        <title>Courses-BBM || Butwal Model College</title>
    ...
    <body>
		...
		<div class="page-title-area ptb-110 bg-opacity-6" style="background-image:url(assets/img/bg/13.jpg)">
			<div class="container">
				<div class="row">
					<div class="col-12">
					...
					<div class="col-lg-9">
						<div class="course-details-wrapper mb-30">
							<div class="course-details-content">
								...
								<h3>Bachelor in Business Manangement</h3>
							</div>
							<div class="course-description-content">
								<h4>Course Description :</h4>
								<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et doloaliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequatDuauirureprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui deserunt mollit anim id est laborum. Sed ut perspiciatis unde omnis iste natus .</p>
							</div>
							<div class="Courses-Features">
								<ul class="Courses-Features-menu">
									<li class="menu-link">
										<h4 class="Courses-Features-title">Courses Features</h4>
									</li>
									<li>
							...
							<div class="requirement-content">
								<h4>Requirement :</h4>
								<ul>
									<li><span class="ti-arrow-right"></span> Lorem ipsum dolor sit amet, consectetur adipisicing elit, </li>
									<li><span class="ti-arrow-right"></span> Lorem ipsum dolor sit amet, consectetur adipisicing elit, </li>
									<li><span class="ti-arrow-right"></span> Lorem ipsum dolor sit amet, consectetur adipisicing elit, </li>
								</ul>
							</div>
		...
		<div class="modal fade" id="myModal" tabindex="-1">
			<div class="modal-dialog modal-lg modal-dialog-centered">
				<div class="modal-content">
					...
					<h5 class="modal-title registers-title">apply now</h5>
					<button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
					</div>
					<div class="modal-body">
						<form action="./admin/content/php/insertapplicants.php" id="registers-now" method="post">
							<div class="row">
								<div class="col-md-6">
									<input type="text" name="name" placeholder="Full name" required>
								</div>
								<div class="col-md-6">
									<input type="text" name="parents" placeholder="Guardian name" required>
								</div>
								<div class="col-md-6">
								...
								<div class="col-12">
									<textarea name="remark" cols="30" rows="10" placeholder="Type Your Text Here" id="message" required></textarea>
								</div>
								<div class="col-12"> 
									<button name="applicantsbtn">Confirm apply</button>
								</div>					
							</div>
						</form>
					</div>
